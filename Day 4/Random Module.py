...
random_number_multiple = random.random() * 10
print(random_number_multiple)
random_number_another_way = random.uniform(20,30)
print(random_number_another_way)
random_coin_flip = random.randint(1,10)
